...
## หน้า "รู้จักหุ้นตัวนี้"

กดปุ่ม `รู้จักหุ้นตัวนี้` ในรายละเอียดหุ้น (แทนที่ปุ่ม PDF Report เดิม ซึ่งย้ายไปอยู่ท้ายหน้านี้แทน) จะเปิดหน้าสรุปที่เรียงตามกรอบของหลักสูตร ONE Investor
