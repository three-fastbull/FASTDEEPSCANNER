...
MEGATRENDS: list[dict[str, Any]] = [
    ...
    {
        "key": "healthcare",
        "name": "Healthcare และ Aging Society",
    ...
    {
        "key": "infrastructure",
        "name": "โครงสร้างพื้นฐานและอุตสาหกรรม",
    ...
    {
        "key": "real_assets",
        "name": "สินทรัพย์จริงและอสังหาริมทรัพย์",
